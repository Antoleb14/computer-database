        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-8 col-xs-offset-2 box">
                    <h1><spring:message code="i18n.editcomputer" /></h1>
                    ...
                    <form id="form" action="editcomputer?computerId=${c.id }" method="POST">
                        ...
                        <fieldset>
                            <div class="form-group name">
                                ...
                                <input type="text" name="name" value="${ c.name }" class="form-control text-danger" id="computerName" placeholder="${computernameP}">
                            ...
                            <div class="form-group introduced">
                                ...
                                <input type="date" name="introduced" value="${ c.introduced }" class="form-control" id="introduced" placeholder="${introducedP }">
                            	<div class="alert alert-danger errmsg" style="display:none;"></div>
                            </div>
                            <div class="form-group discontinued">
                                ...
                                <input type="date" name="discontinued" value="${ c.discontinued }" class="form-control" id="discontinued" placeholder="${ discontinuedP }">
                            	<div class="alert alert-danger errmsg" style="display:none;"></div>
                            </div>
                        ...
                        <div class="actions pull-right">
                        	<spring:message code="i18n.edit" var="editVar" />
                            <input name="submit" type="submit" value="${ editVar }" class="btn btn-primary"></input>
                            or
